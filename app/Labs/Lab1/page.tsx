    ...
    <div id="wd-lab1">
      ...
      <div id="wd-p-tag">
        ...
        <p id="wd-p-3">
          ...
          between the paragraph above and this paragraph, by default browsers render them
          as one contiguous piece of text as shown here on the right.
        </p>
        ...
        <div id="wd-lists">
          ...
          My favorite recipe: Noodles
          <ol id="wd-your-favorite-recipe">
            <li>Boil water</li>
            <li>Open noodles packet and add the noodels into the boiling water</li>
            <li>Let the noodles cook, try breaking it</li>
            <li>Add, the spice mix to the cooked noodles, give it a stir</li>
          ...
          <ul id="wd-your-books">
            ...
            <li>Harry Potter and the sorcers stone</li>
            <li>Football basics a beginners guide to football </li>
          </ul>
        </div>
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <input placeholder="Atharva" id="wd-text-fields-username" /> <br />

          <label htmlFor="wd-text-fields-password">Password:</label>
          <input
            type="password"
            defaultValue="123@sss#$asd"
            id="wd-text-fields-password"
          />
          <br />

          <label htmlFor="wd-text-fields-first-name">First name:</label>
          <input type="text" title="John" id="wd-text-fields-first-name" placeholder="Atharva"/> <br />
        ...
        Please
        <a href="https://github.com/aatharva22/kambaz-next-js" id="wd-lipsum">click here</a>
