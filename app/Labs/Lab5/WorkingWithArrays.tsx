...
<h3>Updating an Item in an Array</h3>
      ...
      <FormControl value={todo.id} className="w-25 float-start me-2"
        onChange={(e) => setTodo({ ...todo, id: e.target.value })}/>
      <FormControl value={todo.description} className="w-50 float-start"
      ...
      <FormControl value={todo.id} className="w-25 float-start me-2"
       ...
       <Form.Check type="checkbox" checked={todo.completed} className="w-50 float-start" id="wd-todo-completed"
